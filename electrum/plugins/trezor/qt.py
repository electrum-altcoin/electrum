...
RECOMMEND_PIN = _(
    ...
    "for your {name_lower}s if your device is lost or stolen.").format(name_lower=constants.net.NAME_LOWER)
PASSPHRASE_NOT_PIN = _(
    "If you forget a passphrase you will be unable to access any "
    "{name_lower}s in the wallet behind it.  A passphrase is not a PIN. "
    "Only change this if you are sure you understand it.").format(name_lower=constants.net.NAME_LOWER)
MATRIX_RECOVERY = _(
...
class SettingsDialog(WindowModalDialog):
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def wipe_device():
            ...
            if wallet and sum(wallet.get_balance()):
                ...
                msg = _("Are you SURE you want to wipe the device?\n"
                        "Your wallet still has {name_lower} in it!").format(name_lower=constants.net.NAME_LOWER)
                if not self.question(msg, title=title,
        ...
        pin_msg = QLabel(_("PIN protection is strongly recommended.  "
                           ...
                           "stealing your {name_lower}s if they obtain physical "
                           "access to your {device}.").format(name_lower=constants.net.NAME_LOWER, device=plugin.device))
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "{device} device can spend your {name_lower}.").format(device=plugin.device, name_lower=constants.net.NAME_LOWER))
        ...
        wipe_device_warning = QLabel(
            _("Only wipe a device if you have the recovery seed written down "
              "and the device wallet(s) are empty, otherwise the {name_lower}s "
              "will be lost forever.").format(name_lower=constants.net.NAME_LOWER))
